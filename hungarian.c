...
double find_smallest_uncovered(double **costs, long *row_covered,long *col_covered, size_t size) __attribute__((nonnull, const));
int find_uncovered_zero(double **costs, long *row_covered, long *col_covered, size_t size, int *row, int *col);
